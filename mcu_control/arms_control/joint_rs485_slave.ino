...
void send_feedback(){
    ...
    int V[3]={state,(int)anglePos_ROS/rad_tick,(int)cmdPos_ROS/rad_tick};
    //int V[3]={1,2,3}; 
    mySerialSendByte.cS='{';  
...
void printTemple(){
        Serial.print(" cmdPos_ROS: "); Serial.print(cmdPos_ROS/degree_tick); 
        Serial.print(" anglePos_ROS: ");Serial.print(anglePos_ROS/degree_tick); 
