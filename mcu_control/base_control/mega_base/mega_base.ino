// follow me wheel speed up to 25rad/s 00076293945
        ...
        if(rP_L == '}')         
          {
            ...
            omega_left_actual = double (left_actual_receive * 0.00076293945); //convert received 16 bit integer to actual speed
          }
      }   
  }
}
    ...
    if(rT_R == '{')
     {
       ...
       if(rP_R == '}')         
       {
        ...
        omega_right_actual = double (right_actual_receive * 0.00076293945); //convert received 16 bit integer to actual speed
       }  
     }
  }   
}
...
{
  // 0.00076293945= 25/10^15 edit for follow me 4/15
  left_target_send = int(omega_left_target/0.00076293945); //convert rad/s to 16 bit integer to send 
...
{
  // 0.00076293945= 25/10^15 edit for follow me 4/15
  right_target_send = int(omega_right_target/0.00076293945); //convert rad/s to 16 bit integer to send
